		...
		<Item Name="Libraries" Type="Folder">
			<Item Name="hse-libraries" Type="Folder">
				<Item Name="hse-application" Type="Folder">
					<Item Name="hse-application.lvclass" Type="LVClass" URL="../Libraries/hse-libraries/hse-application/hse-application.lvclass"/>
				</Item>
				<Item Name="hse-configuration" Type="Folder">
					<Item Name="hse-config-ini" Type="Folder">
						<Item Name="hse-config-ini.lvclass" Type="LVClass" URL="../Libraries/hse-libraries/hse-configuration/hse-config-ini/hse-config-ini.lvclass"/>
					</Item>
					<Item Name="hse-configuration.lvclass" Type="LVClass" URL="../Libraries/hse-libraries/hse-configuration/hse-configuration.lvclass"/>
				</Item>
				<Item Name="hse-db" Type="Folder">
					<Item Name="DB-Engines" Type="Folder">
						<Item Name="ADO-DB-Drivers" Type="Folder">
							<Item Name="_conversion VIs" Type="Folder"/>
							<Item Name="_subVIs" Type="Folder"/>
							<Item Name="_typedefs" Type="Folder"/>
						</Item>
						<Item Name="MySQLTcp" Type="Folder">
					...
					<Item Name="DB-Interface" Type="Folder">
						<Item Name="DB-ADO" Type="Folder"/>
						<Item Name="DB-MySQL" Type="Folder"/>
					</Item>
					<Item Name="DB_CONNECTOR" Type="Folder">
						<Item Name="Clone Registration" Type="Folder"/>
						<Item Name="Query Poly-VIs" Type="Folder"/>
						<Item Name="VI Reference Management" Type="Folder"/>
						<Item Name="DB_CONNECTOR.lvlib" Type="Library" URL="../Libraries/hse-libraries/hse-db/DB_CONNECTOR/DB_CONNECTOR.lvlib"/>
						<Item Name="Test DB_CONNECTOR API.vi" Type="VI" URL="../Libraries/hse-libraries/hse-db/DB_CONNECTOR/Test DB_CONNECTOR API.vi"/>
					</Item>
					<Item Name="hse-db.lvlib" Type="Library" URL="../Libraries/hse-libraries/hse-db/hse-db.lvlib"/>
				</Item>
				<Item Name="hse-dqmh" Type="Folder">
					<Item Name="Controls" Type="Folder"/>
					<Item Name="Dynamic Requesters" Type="Folder">
						<Item Name="Cloneable" Type="Folder"/>
						<Item Name="Singleton" Type="Folder"/>
					</Item>
					<Item Name="hse-dqmh-dynamicrequesters.lvlib" Type="Library" URL="../Libraries/hse-libraries/hse-dqmh/hse-dqmh-dynamicrequesters.lvlib"/>
					<Item Name="hse-dqmh.lvlib" Type="Library" URL="../Libraries/hse-libraries/hse-dqmh/hse-dqmh.lvlib"/>
				</Item>
				<Item Name="hse-gennet" Type="Folder">
					<Item Name="GenNet-Client" Type="Folder">
						...
						<Item Name="VI Reference Management" Type="Folder"/>
						<Item Name="GenNet-Client.lvlib" Type="Library" URL="../Libraries/hse-libraries/hse-gennet/GenNet-Client/GenNet-Client.lvlib"/>
						<Item Name="Test GenNet-Client API.vi" Type="VI" URL="../Libraries/hse-libraries/hse-gennet/GenNet-Client/Test GenNet-Client API.vi"/>
					</Item>
					<Item Name="GenNet-Server" Type="Folder">
						<Item Name="Clone Registration" Type="Folder"/>
						<Item Name="VI Reference Management" Type="Folder"/>
						<Item Name="GenNet-Server.lvlib" Type="Library" URL="../Libraries/hse-libraries/hse-gennet/GenNet-Server/GenNet-Server.lvlib"/>
						<Item Name="Test GenNet-Server API.vi" Type="VI" URL="../Libraries/hse-libraries/hse-gennet/GenNet-Server/Test GenNet-Server API.vi"/>
					</Item>
					<Item Name="UDP Broadcasting" Type="Folder">
						<Item Name="Broadcast Arguments" Type="Folder"/>
					</Item>
					<Item Name="hse-gennet.lvlib" Type="Library" URL="../Libraries/hse-libraries/hse-gennet/hse-gennet.lvlib"/>
				</Item>
				<Item Name="hse-misc" Type="Folder">
					...
					<Item Name="Manipulation" Type="Folder"/>
					<Item Name="Tools" Type="Folder"/>
					<Item Name="hse-misc.lvlib" Type="Library" URL="../Libraries/hse-libraries/hse-misc/hse-misc.lvlib"/>
				</Item>
				<Item Name="hse-networking" Type="Folder">
					<Item Name="FTP" Type="Folder"/>
					<Item Name="NetStream" Type="Folder"/>
					<Item Name="NI-DiscoveryProtocol" Type="Folder"/>
					<Item Name="TCP-Streams" Type="Folder"/>
					<Item Name="UDP" Type="Folder"/>
					<Item Name="hse-network.lvlib" Type="Library" URL="../Libraries/hse-libraries/hse-networking/hse-network.lvlib"/>
				</Item>
				<Item Name="hse-ui" Type="Folder">
					...
					<Item Name="hse-ui.lvlib" Type="Library" URL="../Libraries/hse-libraries/hse-ui/hse-ui.lvlib"/>
				</Item>
				<Item Name="versioninfo.txt" Type="Document" URL="../Libraries/hse-libraries/versioninfo.txt"/>
			</Item>
		</Item>
